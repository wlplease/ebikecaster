...
function voiceLine(line: LineId, request: NextRequest) {
  ...
  if (line === "legal") return "Cycle Pass payments go directly to the treasury on Base. The day pass unlocks unlimited play today, and the lifetime pass unlocks unlimited play permanently. CYCLE credits are gameplay rewards, non-transferable, and have no cash value.";
